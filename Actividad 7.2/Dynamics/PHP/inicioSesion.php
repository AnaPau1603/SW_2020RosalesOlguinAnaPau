  ...
  echo "<div id='inicio_usuarios'>
          ...
          <form action='validacionUsuario.php' method='POST'>
            <fieldset>
              ...
              <input type='password' id='contra' name='contra' title='Utiliza mínimo una mayúscula, una minúscula, un caractér especial(ej.:°|¬!#$%&, etc) y un numero'
              pattern='[\w°|¬!#$%&\/()=?'¡¿¨´*+~[\]@;,:._\-^`]{9}(?=\d|[A-Z]|[a-z]|[\w°|¬!#$%&\/()=?'¡¿¨´*+~[\]@;,:._\-^`]).*'><br><br>";
              //el pattern contraseña no funciona en el html(inicioSesion.php), pero sí en el php de validación(validacionUsuario.php)
